...
if st.session_state.tool_calls:
    st.write("Tool calls made by the LLM:")
    for call in st.session_state.tool_calls:
        st.write(f"- {call['name']}(args={call['args']}, kwargs={call['kwargs']})")
    st.session_state.tool_calls = []  # Reset tool calls for the next iteration